...
mean((dat1[-train, "lm_pred"] - dat1[-train, "GNSQ_FY"])^2)
...
dat1$pur_pred = 0
dat1[dat1$glmpred > 0.5, "pur_pred"] = 1
mean(dat1[-train, "pur_pred"] == dat1[-train, "purchase"]) # 0.685978
```
