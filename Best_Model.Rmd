...
# plotLift(predicted = dat7$GNSQ_FY, labels = dat7$purchase)
t = dim(dat7[dat7$GNSQ_FY > bucket, ])[1]/dim(dat7)[1]
dat7[dat7$glm_pred > t, "pur_pred"] = 1
mean(dat7[-train, "pur_pred"] == dat7[-train, "purchase"]) 
```
* New Threshold chosen by TDL - Prediction accuracy: 0.7972517
...
sumLagMON_AREA       |       0.0017335125    | 1659.24221
