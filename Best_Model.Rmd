...
names(beta)[names(beta) == "BRND_DESCChannel"] = "Channel"
beta = beta[, !grepl("BRND_DESC.*", names(beta))]
beta = data.frame(t(beta))
...
row.names(beta)
dim(beta)
[1] "X.Intercept."         "Channel"              "GNSQ_FYM1"            "sumLagGNSQ"           "IL"                  
 [6] "IA"                   "MI_KY_IN"             "MN_WI"                "MO_KS_CO"             "ND_SD"               
[11] "NE"                   "OH_NorthEastern_sts"  "MON_AREA_FYM1"        "OPPO_CROP_AREA_FYM1"  "RECENCY_SCORE_FYM1"  
[16] "FREQUENCY_SCORE_FYM1" "MONETARY_SCORE_FYM1"  "PURCH_PRBLTY_FYM1"  
